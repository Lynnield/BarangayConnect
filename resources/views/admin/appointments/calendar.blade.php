    ...
    @if($items->isEmpty())
        <x-card class="bg-slate-900/70 border-slate-800 text-center">
            <div class="py-12">
                ...
                <p class="mt-3 text-sm text-slate-400">There are no scheduled appointments for this month. Use admin schedules instead of creating appointments here.</p>
                <x-button href="{{ route('admin.appointments.slots') }}" variant="primary" size="sm" icon="clock" class="mt-6">
                    Manage Schedules
                </x-button>
            </div>
        </x-card>
                        ...
                        @foreach($list as $item)
                            ...
                            <div class="rounded-3xl border border-slate-800 bg-slate-900/70 p-4 sm:p-5 flex flex-col gap-4 sm:flex-row sm:items-center sm:justify-between">
                                ...
                                <div class="flex flex-col gap-3 sm:items-end">
                                    ...
                                    <x-button href="{{ route('admin.appointments.show', $item) }}" variant="secondary" size="xs" icon="external-link">
                                        View details
                                    </x-button>
                                </div>
                            </div>
