...
@section('breadcrumb')
    ...
    <span class="text-slate-300">Create Type</span>
@endsection
...
<div class="w-full max-w-4xl mx-auto space-y-8 animate-in fade-in slide-in-from-bottom-4 duration-700">
    ...
    <div class="flex items-center gap-4">
        <a href="{{ route('admin.document-types.index') }}" class="h-10 w-10 flex items-center justify-center rounded-xl bg-slate-800 border border-slate-700 text-slate-400 hover:text-white hover:border-slate-600 transition-all">
            <i data-lucide="arrow-left" class="h-5 w-5"></i>
        </a>
        <div>
            <h1 class="text-2xl font-black text-white tracking-tight">Add Document Type</h1>
            <p class="text-sm text-slate-500 font-medium mt-1">Configure a new official document service for residents.</p>
        </div>
    </div>

    <x-card class="bg-slate-900/50 border-slate-800" :padding="false">
        <form method="POST" action="{{ route('admin.document-types.store') }}" class="p-8 space-y-8">
            @csrf
            ...
            <div class="space-y-6">
                <div class="flex items-center gap-3">
                    ...
                    <h2 class="text-xs font-black text-white uppercase tracking-[0.2em]">Service Definition</h2>
                </div>

                <div class="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div class="md:col-span-1 space-y-2">
                        <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Service Name</label>
                    ...
                    <div class="md:col-span-2 space-y-2">
                        <label class="text-[10px] font-black text-slate-500 uppercase tracking-widest ml-1">Service Description</label>
                ...
                <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input type="number" step="0.01" name="fee" value="0.00" required
                    ...
                    <div class="space-y-2">
                        ...
                        <div class="relative group">
                            ...
                            <input type="number" name="processing_days" value="1" required
